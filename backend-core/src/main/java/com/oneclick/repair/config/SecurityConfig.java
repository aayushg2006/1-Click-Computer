...
import com.oneclick.repair.security.PublicRateLimitFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(new PublicRateLimitFilter(rateLimitService), UsernamePasswordAuthenticationFilter.class);
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "http://10.0.2.2:3000", "http://10.0.2.2:8080"));
